    ...
    <>
      ...
      <div className="mx-auto py-16 px-4 w-full md:w-2/3 text-gray-800 text-white">
        ...
        <p className="mb-4">
          ...
          is incorporated into and is subject to the LocalSolana Terms of
          Service and LocalSolana Protocol Disclaimer, describes the information
          that we gather from you on the Site, how we use and disclose such
        ...
        <ul className="list-disc pl-6">
          <li className=" mb-2">
            ...
            . When you connect your non-custodial blockchain wallet to the Site,
            we collect and log your publicly-available blockchain address to
            learn more about your use of the Services and to screen your wallet
            for any prior illicit activity. We screen your wallet using
            intelligence provided by blockchain analytics providers. Note that
            blockchain addresses are publicly-available data that are not
          ...
          <li className=" mb-2">
            ...
            When you use the Site, we may send one or more cookies – small text
            files containing a string of alphanumeric characters – to your
            device. We may use both session cookies and persistent cookies. A
            ...
            browser on subsequent visits to the Site. Please review your web
        ...
        <ul className="list-disc pl-6">
          <li className=" mb-2">
            ...
            and information that you request, to respond to comments and
            questions and otherwise to provide support to users, and to process
        ...
        <p className="mb-4">
          ...
          receiving such information. You may exercise that right by clicking
          the “unsubscribe” link in a message we send you, or through contact us
        ...
        <ul className="list-disc pl-6">
          ...
          <li className=" mb-2">
            ...
            (iv) protect the security or integrity of the Site and any
            facilities or equipment used to make the Site available; or (v)
        ...
        <p className="mb-4">
          ...
          account preferences page on the Site. If you wish to access or amend
        ...
        <p className="mb-4">
          ...
          services and is subject to those operators’ policies, if any,
          governing privacy and security, even if accessed through the Site. We
          are not responsible for the content or privacy and security practices
          and policies of third-party sites or services to which links or access
          are provided through the Site. We encourage you to learn about third
        ...
        <p className="mb-4">
          ...
          children under the age of 18. If you believe we have received personal
          information about a child under the age of 18, please contact us at
        ...
        <p className="mb-4">
          ...
          impenetrable. We cannot and do not guarantee that information about
          you will not be accessed, viewed, disclosed, altered, or destroyed by
        ...
        <p className="mb-4">
          ...
          reasonable efforts to notify you of the change. Your continued use of
          the Site after the revised Policy has become effective indicates that
          you have read, understood and agreed to the current version of this
          Policy.
        </p>
